...
const (
	...
	// Interval is the default gap between reports. The server can
	...
	// Heartbeat is how often the TUI checks whether a report is due. It
...
// URL returns the collector endpoint. GRC_PEER_SHARING_URL overrides
...
// ClampInterval keeps a server-suggested cadence inside sane bounds.
